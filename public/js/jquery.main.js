                ...
                <ul class="nav navbar-nav">
                      ...
                      <div class="drop-wrap">
                        <div class="five-col">
                          ...
                          <div class="column">
                            ...
                            <ul class="header-link">
                              <li>
                                <a href="/odmori-u-prirodi"
                                  >Одмори у природи</a
                                >
                              </li>
                              <li>
                                <a href="/izletiste-borkovac"
                                  >Излетиште Борковац</a
                                >
                              </li>
                              <li>
                                <a href="/bara-traskovaca"
                                  >ЗС "Бара Трсковача"</a
                                >
                              </li>
                            </ul>
                          ...
                          <div class="column">
                            ...
                            <ul class="header-link">
                              <li>
                                <a href="/sport-rekreacija"
                                  >Спорт и рекреација"</a
                                >
                              </li>
                              <li>
                                <a href="/bazen-borkovac"
                                  >Базен "Борковац"</a
                                >
                              </li>
                              <li>
                                <a href="/sportski-centri"
                                  >Спортски центри</a
                                >
                              </li>
                              <li>
                                <a href="/fitnes-centri">Фитнес центри</a>
                              </li>
                            </ul>
                          </div>
                          <div class="column">
                          ...
                          <div class="column">
                            ...
                            <ul class="header-link">
                              <li>
                                <a href="/lov-i-ribolov">Лов и риболов</a>
                              </li>
                              <li>
                                <a href="/terapijsko-jahanje"
                                  >Терапијско јахање</a
                                >
                              </li>
                              <li><a href="/restorani">Ресторани</a></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                  ...
                  <li class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <ul>
                        ...
                        <li>
                          <a href="/moteli">Мотели</a>
                        </li>
                        <li>
                          <a href="/prenocista">Преноћишта</a>
                        </li>
                        <li>
                          <a href="/apartmani">Апартмани</a>
                        </li>
                      </ul>
                    </div>
                  </li>
                      ...
                      <div class="drop-wrap">
                        <div class="row">
                          <div class="col-sm-6">
                            ...
                            >
                              <li>
                                <a href="/zanatstvo-trgovina">
                                  Занатство и трговина</a
                                >
                              </li>
                              <li>
                                <a
                                  href="/cehovska-povelja"
                                  style="margin-left: 15px"
                                  >- Цеховска повеља</a
                                >
                              </li>
                              <li>
                                <a href="/zanatski-proizvodi" style="margin-left: 15px"
                                  >- Занатски производи</a
                                >
                              </li>
                              <li>
                                <a href="/gastronomski-proizvodi" style="margin-left: 15px"
                                  >- Гастрономски производи</a
                                >
                              </li>
                              <li>
                                <a href="/rukotvorine" style="margin-left: 15px">- Рукотворине</a> 
                              </li>
                            </ul>
                          </div>
                          <div class="col-sm-6">
                            <ul class="header-link">
                              <li>
                                <a href="/rumski-vasar">Румски вашар</a>
                              </li>
                            </ul>
                          </div>
                        </div>
                  ...
                  <li class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <ul>
                        <li>
                          <a href="/kako-stici">Локација како стићи</a>
                        </li>
                        <li>
                          <a href="/korisne-informacije"
                            >Корисне информације</a
                          >
                        </li>
                        <li>
                          <a href="/turisticki-info-centar"
          ...
          <div class="row footer-holder">
            <nav class="col-sm-4 col-lg-2 footer-nav active">
              ...
              <ul class="slide">
                ...
                <li><a href="/arheologija">Археологија</a></li>
                <li><a href="/sela">Села</a></li>
                <li><a href="/znameniti-rumljani">Знаменити Румљани</a></li>
              </ul>
            </nav>
            <nav class="col-sm-4 col-lg-2 footer-nav">
              <h3>Шта радити</h3>
              <ul class="slide">
                <li><a href="/tematske-setnje">Тематске шетње</a></li>
                <li><a href="/odmori-u-prirodi">Одмори у природи</a></li>
                <li><a href="/sport-rekreacija">Спорт и рекреација</a></li>
                <li><a href="/velnes">Велнес</a></li>
                <li><a href="/lov-i-ribolov">Лов и риболов</a></li>
                <li><a href="/terapijsko-jahanje">Терапијско јахање</a></li>
                <li><a href="/restorani">Ресторани</a></li>
            ...
            <nav class="col-sm-4 col-lg-2 footer-nav">
              <h3>Шта видети</h3>
              <ul class="slide">
                <li><a href="/ustanove-kulture">установе културе</a></li>
                <li><a href="/sakrana-bastina">Сакрана баштина</a></li>
                <li><a href="/spomenici">Споменици</a></li>
                <li><a href="/gradsko-nasledje">Градско наслеђе</a></li>
              </ul>
            </nav>
            <nav class="col-sm-4 col-lg-2 footer-nav">
              <h3>Где преспавати</h3>
              <ul class="slide">
                <li><a href="/hoteli">Хотели</a></li>
                <li><a href="/moteli">Мотели</a></li>
                <li><a href="/prenocista">Преноћишта</a></li>
                <li><a href="/apartmani">Апартмани</a></li>
              </ul>
            </nav>
            <nav class="col-sm-4 col-lg-2 footer-nav">
              <h3>Инфо</h3>
              <ul class="slide">
                <li><a href="/kako-stici">Локације како стићи</a></li>
                <li><a href="/korisne-informacije">Корисне информације</a></li>
                <li><a href="/turisticki-info-centar">Туристички инфоцентар</a></li>
                <li><a href="/vesti">Вести</a></li>
              </ul>
            </nav>
