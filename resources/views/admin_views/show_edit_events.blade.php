...
<body>
    ...
    <div class="add_news_container">
        <form action="{{ route('update_event', $event->id) }}" enctype="multipart/form-data" method="POST" class="add_news_form">
            @csrf
            ...
            <textarea name="content" class="content" id="content">{{ $event->content }}</textarea>
