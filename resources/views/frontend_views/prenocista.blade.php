            ...
            <div class="center-text">
              <div class="container">
                ...
                <strong class="subtitle"
                  >Туристичка организација општине Рума</strong
                >
              </div>
            </div>
          </div>
        </section>
        <!-- main container moteli/hoteli/apartmani -->
        <main>
                        ...
                        <footer class="info-footer">
                          <ul class="ico-list">
                            <li class="pop-opener">
                              ...
                              <div class="popup">Базен</div>
                            </li>
                            <li class="pop-opener">
                              <span class="icon-boat"></span>
                              <div class="popup">Ресторан</div>
                            </li>
                            <li class="pop-opener">
                              <span class="icon-food-wine"></span>
                              <div class="popup">Забаве</div>
                            </li>
                            <li class="pop-opener">
                              <span class="icon-water"></span>
                              <div class="popup">Велнес</div>
                            </li>
                          </ul>
                        </footer>
                      </div>
                      <aside class="info-aside" style="height: 200px; display: flex; align-items: center; padding-left: 10px;">
                        <div class="activity-level">
                        <a
                          href="https://goo.gl/maps/6fZjqJYNax8iw8uRA"
