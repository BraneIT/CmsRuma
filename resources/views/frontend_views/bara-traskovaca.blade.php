                            ...
                            <ul class="side-list horizontal-list hovered-list">
                              <li>
                                <a href="tematske-setnje.html">
                                  ...
                                  <span class="popup"> Тематске шетње </span>
                                </a>
                              </li>
                              <li>
                                <a href="lov-ribolov">
                                  <span class="icon-wildlife"></span>
                                  <span class="popup"> лов &amp; Риболов </span>
                                </a>
                              </li>
                              <li>
                                <a href="odmori-u-prirodi.html">
                                  <span class="icon-tree"></span>
                                  <span class="popup"> Одмори у природи </span>
                                </a>
                              </li>
                              <li>
                                <a href="restorani.html">
                                  <span class="icon-food-wine"></span>
                                  <span class="popup"> Ресторани </span>
                                </a>
                              </li>
                              <li>
                                <a href="sport-rekreacija.html">
                              ...
                              <li>
                                <a href="wellnes.html">
                                  <span class="icon-dolphin-76"></span>
                                  <span class="popup"> Велнес </span>
                                </a>
                              </li>
                              <li>
                                <a href="bazen-borkovac.html">
                                  <span class="icon-sunny"></span>
                                  <span class="popup"> Базен "Борковац" </span>
                                </a>
                              </li>
                              <li>
                                <a href="terapijsko-jahanje.html">
                                  <span
                                    ><img
                                      src="img/icons/horse-riding.svg"
                                      alt=""
                                      srcset=""
                                    />
                                  </span>
                                  <span class="popup"> Туристичко јахање </span>
                                </a>
                              </li>
                            </ul>
                          </div>
