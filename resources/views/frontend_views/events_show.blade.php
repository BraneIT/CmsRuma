...
<html>
  ...
  <body>
        ...
        >
          <div class="banner-text">
            <div class="center-text">
              <div class="container">
                <h1>НАСЛОВ ВЕСТ</h1>
                <strong class="subtitle">Кратак опис вести</strong>
                <!-- breadcrumb -->
              </div>
            </div>
          </div>
                  ...
                  <div class="blog-holder no-pagination">
                    ...
                    <article class="blog-single">
                      ...
                      <div class="description">
                        <h1 class="content-main-heading">{{ $event->title }}</h1>
                        <p>
                        {!! $event->content !!}
                        </p>
                        <!-- <p>
                        ...
                        <footer class="meta-article">
                          <div class="footer-sub">
                            <div class="rate-info">
                              <!-- Kreator posta: <a href="#">$event->created_by</a> -->
                            </div>
                          </div>
                        </footer>
                      </div>
    ...
    <script src="{{URL::asset('vendors/retina/retina.min.js')}}"></script>
    ...
    <!-- custom script -->
    <script src="{{URL::asset('js/jquery.main.js')}}"></script>
  </body>
</html>
